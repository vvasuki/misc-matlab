...
void doBatchUpdate4VariationI();
void doBatchUpdate4VariationII();
void doBatchUpdate4VariationIII();
void doBatchUpdate4VariationIV();
//void MssrIIcc::doBatchUpdate4VariationV();
    virtual void doBatchUpdate(bool *isInversed);
void doBatchUpdate4VariationI(bool *isInversed);
void doBatchUpdate4VariationII(bool *isInversed);
void doBatchUpdate4VariationIII(bool *isInversed);
void doBatchUpdate4VariationIV(bool *isInversed);
