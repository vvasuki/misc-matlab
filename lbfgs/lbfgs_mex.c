...
lbfgs_t *lbfgs_init(int n, int r, int c, double *x0, double *lbd, double *ubd, double *nbd, lbfgs_opts_t opts);
...
int nrhs, const mxArray *prhs[])
{
	...
	l = lbfgs_init(n, r, c, x0, lbd, ubd, nbd, opts);
...
int nrhs, const mxArray *prhs[])
{
	...
	plhs[0] = mxCreateDoubleMatrix(l->r, l->c, mxREAL);
	x = mxGetPr(plhs[0]);
...
lbfgs_t *
lbfgs_init(int n, int r, int c, double *x0, double *lbd, double *ubd, double *nbd,
lbfgs_opts_t opts)
{
